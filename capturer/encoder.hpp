...
public:
    ...
    int getFrame(int frameNo, unsigned char* inbuf, int inlen, unsigned char* outbuf, int &outlen )
    {
        return encode(frameNo, inbuf, inlen, outbuf, outlen );
    }
...
private:
    ...
    int encode( int frameNo, unsigned char *inbuf, int inlen, unsigned char* outbuf, int &outlen )
    {
